...
const (
	Msg_CreateFunder_FullMethodName = "/kyve.funders.v1beta1.Msg/CreateFunder"
	Msg_UpdateFunder_FullMethodName = "/kyve.funders.v1beta1.Msg/UpdateFunder"
	Msg_FundPool_FullMethodName     = "/kyve.funders.v1beta1.Msg/FundPool"
	Msg_DefundPool_FullMethodName   = "/kyve.funders.v1beta1.Msg/DefundPool"
	Msg_UpdateParams_FullMethodName = "/kyve.funders.v1beta1.Msg/UpdateParams"
)
...
func (c *msgClient) CreateFunder(ctx context.Context, in *MsgCreateFunder, opts ...grpc.CallOption) (*MsgCreateFunderResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_CreateFunder_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UpdateFunder(ctx context.Context, in *MsgUpdateFunder, opts ...grpc.CallOption) (*MsgUpdateFunderResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_UpdateFunder_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreateFunder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_CreateFunder_FullMethodName,
	}
...
func _Msg_UpdateFunder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_UpdateFunder_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
